...
export const VisitorIntegration = () => {
  ...
  const onSaveVisitor = async (formData) => {
    try {
  ...
  return (
    <Visitor
      ...
      onGoBack={onGoBack}
      onSaveVisitor={onSaveVisitor}
    />
  );
};

const Visitor = ({ visitor, savingVisitor, onGoBack, onSaveVisitor }) => {
  ...
  const onSubmitVisitor = (formData) => onSaveVisitor(formData);
