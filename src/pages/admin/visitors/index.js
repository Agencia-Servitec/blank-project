...
import {Button, IconAction,modalConfirm,notification,} from "../../../components/admin/ui";
...
export const Visitors = () => {
    ...
    const onEditVisitor = (visitorId)=>onNavigate(`/admin/visitors/${visitorId}`);
    ...
    return (
        <>
            <Row gutter={[16,16]}>
                <Col span={24}>
                    <Button type="primary" onClick={()=> onAddVisitor()}>Agregar</Button>
                </Col>
                <Divider/>
                <Col span={24}>
